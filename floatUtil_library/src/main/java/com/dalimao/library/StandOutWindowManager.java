...
public class StandOutWindowManager {
    ...
    static StandOutLayoutParams mParams;
     ...
     */
    public void show(Class<? extends WindowWrapper> cls, Bundle args, boolean shouldCloseAll, boolean allowAnimation) {
        ...
        show(cls, args, null, allowAnimation);
    }

    public void showView(View view, Bundle args, int gravity, boolean allowAnimation) {
        ...
        showWrapper(wrapper, args, null, view, allowAnimation);
    }
    ...
    public void showView(View view, Bundle args, boolean allowAnimation){

        showView(view, args, Gravity.TOP | Gravity.LEFT, WindowManager.LayoutParams.TYPE_PHONE, allowAnimation);
    }
    ...
    public void showView(View view, Bundle args, int gravity ,int type, boolean allowAnimation){
    ...
    public void showView(View view, Bundle args, int gravity , int type, Point point, boolean allowAnimation){

        showView(view, args, gravity, type, point, allowAnimation);
    }
    ...
    public void showView(View view, Bundle args, int gravity, int type, Point point, boolean drag, boolean allowAnimation) {
        final WindowWrapper wrapper = getWindowWrapper(CommonWindowWrapper.class, null , view.getClass().hashCode());
        ...
        params.x = point.x;
        params.y = point.y;
        Log.d(TAG,"showView: params.flag="+params.flags);
        wrapper.setStandOutLayoutParams(params);
        showWrapper(wrapper, args, null, view, allowAnimation);

        mParams = wrapper.getStandOutLayoutParams();
     ...
     */
    public void show(Class<? extends WindowWrapper> cls, Bundle args, Class<? extends WindowWrapper> anchor, boolean closeAnchor, boolean allowAnimation) {
        int anchorId = anchor.hashCode();
        if (closeAnchor && isExistingId(anchorId)) {
            close(anchorId, !allowAnimation);
        }
        ...
        show(cls, args, anchorWindow, allowAnimation);
    }

    protected final void show(Class<? extends WindowWrapper> cls, boolean allowAnimation) {
        show(cls, null, null, allowAnimation);
    }

    protected final void show(Class<? extends WindowWrapper> cls, Bundle args, boolean allowAnimation) {
        show(cls, args, null, allowAnimation);
    }
     ...
     */
    public synchronized Window show(Class<? extends WindowWrapper> cls, Bundle args, Window anchor, boolean allowAnimation) {
        final WindowWrapper wrapper = getWindowWrapper(cls, anchor , cls.hashCode());
        Window window = showWrapper(wrapper, args, anchor, null, allowAnimation);

        return window;
    }

    private Window showWrapper(WindowWrapper wrapper, Bundle args, Window anchor, View child, boolean allowAnimation) {
        if(wrapper == null) {
            return null;
        }
...
//            }
        ...
        try {
            ...
            // animate
            if(allowAnimation==true && animation != null ) {
     ...
     */
    public final void hide(Class<? extends WindowWrapper> cls, final boolean ignoreAnim) {
    ...
    /*private void hide(final WindowWrapper wrapper, final boolean ignoreAnim) {
        hide(wrapper, ignoreAnim);
    }*/
     ...
     *           The class of the window.
     */
    public final synchronized void close(Class<? extends WindowWrapper> cls, boolean ignoreAnim) {
        final int id = cls.hashCode();
        final WindowWrapper wrapper = getWindowWrapperFromCache(id);
        if (wrapper == null) {
            return;
    ...
    public final synchronized void close(final WindowWrapper wrapper, boolean ignoreAnim) {
       ...
       // mContext.cancelNotificationOnClose();
        ...
        try {
            ...
            if (!ignoreAnim && animation != null && windowContent != null) {  // animate
    ...
    private void close(LinkedList<Integer> ids, boolean ignoreAnim) {
        // close each window
        for (int id : ids) {
            if(isExistingId(id)) {
                close(id, ignoreAnim);
    ...
    private void close(int windowId, boolean ignoreAnim) {
        WindowWrapper wrapper = mWindowWrappers.get(windowId);
        if (wrapper != null) {
            close(wrapper, ignoreAnim);
        }
    ...
    public boolean onTouchHandleMove(Window window, View view, MotionEvent event) {
        ...
        StandOutLayoutParams params = window.getLayoutParams();
        mParams = window.getLayoutParams();
    ...
    public void hideView(Class<? extends View> viewClass, boolean cache, boolean ignoreAnim) {
        ...
        if (cache) {
            ...
            close(viewClass.hashCode(), ignoreAnim);
        }
